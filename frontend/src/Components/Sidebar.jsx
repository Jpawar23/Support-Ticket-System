...
const navigation = [
    ...
    { name: 'Tickets', to: '/ticket', icon: UsersIcon, current: false, role: "admin" },
    // { name: 'Dashboard', to: '/employee-dashboard', icon: FolderIcon, current: false },
    // { name: 'Tickets', to: '/employee-ticket', icon: FolderIcon, current: false },
    { name: 'Create Ticket', to: '/create-ticket', icon: FolderIcon, current: false },
]
